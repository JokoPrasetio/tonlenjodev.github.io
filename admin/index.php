           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a href="index.php?halaman=kategori">Kategori</a>
                    </li>
                    <li>
                    ...
                    <li> 
                        <a href="index.php?halaman=laporanpembelian">Laporan Pembelian</a>
                    </li>
                    <li>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                if(isset($_GET['halaman'])){
                    ...
                    }elseif($_GET['halaman']=='detailinfo'){
                        include 'detailinfo.php';
